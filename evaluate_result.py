...
post_processing_method = 'Fix Threshold'
classes = '1kelas'
path_true_label = "1kelas/test/label/*jpg"
path_predicted_label = "1kelas/test/test result/*.jpg"
...
print("{0:.2f}".format(np.average(list_pixel_acc) * 100))
print("{0:.2f}".format(np.average(list_mean_IU) * 100))
print("{0:.2f}".format(np.average(list_mean_acc) * 100))
print("{0:.2f}".format(np.average(list_fpr) * 100))
print("{0:.2f}".format(np.average(list_precision) * 100))
print("{0:.2f}".format(np.average(list_recall)  * 100))
print("{0:.2f}".format(np.average(list_f1_score)  * 100))
